...
namespace SendFire.Common.Tests.Process
{
    public class CommandLineExecutionProviderTest
    {
        ...
        public void ProcessCommand(string[] args, bool runAsBatch)
        {
            var commandLineExecution = new CommandLineExecutionProvider(args, runAsBatch);
        ...
        public void ProcessSysCommand(string[] args, bool runAsBatch)
        {
            var commandLineExecution = new CommandLineExecutionProvider(args, runAsBatch);
            var output = commandLineExecution.ProcessCommand();
            Assert.NotEmpty(output);
        ...
        public void ProcessSysCommand2(string[] args, bool runAsBatch)
        {
            var commandLineExecution = new CommandLineExecutionProvider(args, runAsBatch);
            var output = commandLineExecution.ProcessCommand();
            Assert.NotEmpty(output);
        ...
        public void ProcessMultipleCommands(string[] args, bool runAsBatch)
        {
            var commandLineExecution = new CommandLineExecutionProvider(args, runAsBatch);
            var output = commandLineExecution.ProcessCommand();
            Assert.NotEmpty(output);
        ...
        public void ProcessMultipleCommands2(string[] args, bool runAsBatch)
        {
            var commandLineExecution = new CommandLineExecutionProvider(args, runAsBatch);
            var output = commandLineExecution.ProcessCommand();
            Assert.NotEmpty(output);
